...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/mesprojets/seminairePHP/SanteAnimale/Accueil/index">
            <div class="sidebar-brand-icon">
                <i class="fas fa-laugh-wink"></i>
            </div>
            <div class="sidebar-brand-text mx-3">Sante Animale </div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('/animal/getAll') }}" >
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('/veto/getAll') }}" >
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('/consultation/getAll') }}" >
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" id="seachvalue" class="form-control bg-light border-0 small" placeholder="Search student..." aria-label="Search" aria-describedby="basic-addon2">
